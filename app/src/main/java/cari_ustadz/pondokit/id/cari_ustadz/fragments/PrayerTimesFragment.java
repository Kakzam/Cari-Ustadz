...
import cari_ustadz.pondokit.id.cari_ustadz.activities.MuezzinActivity;
...
import cari_ustadz.pondokit.id.cari_ustadz.utilities.RemainingTime;
...
public class PrayerTimesFragment extends StatefulFragment implements MuezzinAPI.OnPrayerTimesDownloadedListener {
    ...
    @Override public void onAttach(Context context) {
        ...
        try {
            ...
            defaultTextColor = typedArray.getResources().getColor(android.R.color.white);
            typedArray.recycle();
